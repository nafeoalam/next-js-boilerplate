...
/**
 * usage
 * wrap your function with debounce then call it, ex: const newFunction = debounce(func, 1000,{isImmediate: true})
 * for more info: https://github.com/chodorowicz/ts-debounce#readme
 */
